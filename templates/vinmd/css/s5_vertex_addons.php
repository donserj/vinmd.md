...
<?php if ($s5_responsive_row_widths_top_row_1 != "default"){
...
<?php if ($s5_responsive_row_widths_top_row_2 != "default"){
...
<?php if ($s5_responsive_row_widths_top_row_3 != "default"){
...
<?php if ($s5_responsive_row_widths_above_columns != "default"){
...
<?php if ($s5_responsive_row_widths_middle_top != "default"){
...
<?php if ($s5_responsive_row_widths_above_body != "default"){
...
<?php if ($s5_responsive_row_widths_middle_bottom != "default"){
...
<?php if ($s5_responsive_row_widths_below_body != "default"){
...
<?php if ($s5_responsive_row_widths_below_columns != "default"){
...
<?php if ($s5_responsive_row_widths_bottom_row_1 != "default"){
...
<?php if ($s5_responsive_row_widths_bottom_row_2 != "default"){
...
<?php if ($s5_responsive_row_widths_bottom_row_3 != "default"){
